(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_0cda92._.js", {
...
const ModelosPage = ()=>{
    ...
    const fetchModelos = async (idcategoria)=>{
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].categories.getAll(idcategoria);
            console.log(response.data, 'desde categoria ');
            setModelos(response.data.map((modelo)=>({
                    id: modelo.mfa_id,
                    imageSrc: modelo.imageSrc || "/placeholder.png",
...
//# sourceMappingURL=src_0cda92._.js.map