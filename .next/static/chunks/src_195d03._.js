...
;
;
const CardCatalogo = ({ imageSrc, text, level, categoria, marca, linea })=>{
    _s();
    ...
    const normalizeText = (text)=>text ? text.trim().replace(/\s+/g, '_').replace(/\//g, '-') : '';
...
_s(CardCatalogo, "KcyYPUEXxO8z28HL4srajpAd3Go=", false, function() {
    return [
...
;
;
const Breadcrumb = ({ categoria, marca, linea })=>{
    _s();
    const router = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$15$2e$1$2e$6_react$2d$dom$40$19$2e$0$2e$0_react$40$19$2e$0$2e$0_$5f$react$40$19$2e$0$2e$0$2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"])();
    // Normaliza texto para URL
    const normalize = (text)=>text ? text.trim().replace(/\s+/g, "_").replace(/\//g, "-") : "";
    const breadcrumbs = [];
