...
const MarcasPage = ()=>{
    ...
    const fetchMarcas = async (idmarca, idcategoria)=>{
        try {
            const { data } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].line.getAll(idcategoria, idmarca); // 🔥 Llamar a la API para obtener marcas
